 ...
 */
public class TypeCompletionTest extends NbTestCase {
    ...
    public TypeCompletionTest(String testName) {
        super(testName);
    }

    public static Test suite() {
        return NbModuleSuite.createConfiguration(TypeCompletionTest.class)
    ...
    private void setConfigurationForTypeCompletion() {
        ...
        Settings.setSettingForInternalType(true);
    ...
    public void testTypeCompletionInReturnStatement() throws IOException {
        doAbbreviationInsert(
                ...
                "class InstanceOfTree {\n"
                + "    InstanceOfTree test() {\n"
                + "        return new InstanceOfTree();\n"
                + "    }\n"
                + "}",
                Arrays.asList("InstanceOfTree"));
    }
