...
public class ConstantDataManager {
    ...
    public static final List<Character> FORBIDDEN_FIRST_CHARS = Arrays.asList('~', '!', '@', '#', '$', '%', '^', '&',
            '*', '(', ')', '-', '+', '_', '=', '/', '{', '}', '[', ']', '|', '\\', ':', ';', '\'', '"', '<', '>', ',',
            '.', '?');
    public static final String INVALID_CARET_POSITION = "The 'caretPosition' argument is out of bounds of document!"; //NOI18N
    ...
    public static final String STATE_IS_NOT_IN_PHASE_RESOLVED = "Could not move state to Phase.RESOLVED!"; //NOI18N
