...
import static com.github.isarthur.netbeans.editor.typingaid.codefragment.api.CodeFragment.Kind.THROWS_KEYWORD;
 ...
 */
public class ThrowsKeyword extends AbstractKeyword {
    ...
    public Tree getTreeToInsert(CodeCompletionRequest request) {
        return JavaSourceMaker.makeThrowsTree("IllegalArgumentException", request); //NOI18N
    }
