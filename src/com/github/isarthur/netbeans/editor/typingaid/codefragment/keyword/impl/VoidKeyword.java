...
import static com.github.isarthur.netbeans.editor.typingaid.codefragment.api.CodeFragment.Kind.VOID_KEYWORD;
 ...
 */
public class VoidKeyword extends AbstractKeyword {
    ...
    public Tree getTreeToInsert(CodeCompletionRequest request) {
        return JavaSourceMaker.makeVoidTree(request);
    }
