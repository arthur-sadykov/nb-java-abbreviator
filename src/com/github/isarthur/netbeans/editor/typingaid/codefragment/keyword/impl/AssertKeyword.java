...
import static com.github.isarthur.netbeans.editor.typingaid.codefragment.api.CodeFragment.Kind.ASSERT_KEYWORD;
 ...
 */
public class AssertKeyword extends AbstractKeyword {
    ...
    public Tree getTreeToInsert(CodeCompletionRequest request) {
        return JavaSourceMaker.makeAssertTree(request);
    }

    @Override
    public String toString() {
        return "assert"; //NOI18N
    }
}
