...
import static com.github.isarthur.netbeans.editor.typingaid.codefragment.api.CodeFragment.Kind.ELSE_KEYWORD;
 ...
 */
public class ElseKeyword extends AbstractKeyword {
    ...
    public Tree getTreeToInsert(CodeCompletionRequest request) {
        return JavaSourceMaker.makeElseTree(request);
    }
