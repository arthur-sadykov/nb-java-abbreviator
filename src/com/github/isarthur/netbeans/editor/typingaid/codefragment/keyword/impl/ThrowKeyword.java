...
import static com.github.isarthur.netbeans.editor.typingaid.codefragment.api.CodeFragment.Kind.THROW_KEYWORD;
 ...
 */
public class ThrowKeyword extends AbstractKeyword {
    ...
    public Tree getTreeToInsert(CodeCompletionRequest request) {
        return JavaSourceMaker.makeThrowTree(request);
    }
