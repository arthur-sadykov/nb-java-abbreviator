 ...
 */
public class ChainedEnumConstantAccessCollector extends CodeFragmentCollector {

    @Override
    public void collect(Request request) {
        request.getSourceHelper().collectChainedEnumConstantAccesses(request.getCodeFragments(), request.getController());
        super.collect(request);
    }

    @Override
    public Kind getKind() {
        return Kind.CHAINED_ENUM_CONSTANT_ACCESS;
    }
}
