 ...
 */
public class MethodInvocationCollector extends CodeFragmentCollector {

    @Override
    public void collect(Request request) {
        request.getSourceHelper().collectMethodInvocations(request.getCodeFragments(), request.getController());
