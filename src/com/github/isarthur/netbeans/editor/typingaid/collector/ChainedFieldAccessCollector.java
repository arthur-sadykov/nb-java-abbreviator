 ...
 */
public class ChainedFieldAccessCollector extends CodeFragmentCollector {

    @Override
    public void collect(Request request) {
        request.getSourceHelper().collectChainedFieldAccesses(request.getCodeFragments(), request.getController());
