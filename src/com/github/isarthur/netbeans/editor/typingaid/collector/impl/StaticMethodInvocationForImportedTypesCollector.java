 ...
 */
public class StaticMethodInvocationForImportedTypesCollector extends CodeFragmentCollector {

    @Override
    public void collect(Request request) {
        request.getSourceHelper().collectStaticMethodInvocationsForImportedTypes(
    ...
    @Override
    public Kind getKind() {
        return Kind.STATIC_METHOD_INVOCATION_FOR_IMPORTED_TYPES;
    }
}
