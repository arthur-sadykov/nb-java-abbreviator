 ...
 */
public class PrimitiveTypeCollector extends CodeFragmentCollector {

    @Override
    public void collect(Request request) {
        request.getSourceHelper().collectPrimitiveTypes(request.getCodeFragments(), request.getController());
