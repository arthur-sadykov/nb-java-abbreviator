...
import com.github.isarthur.netbeans.editor.typingaid.insertvisitor.impl.CompilationUnitCodeFragmentInsertVisitor;
 ...
 */
public class CompilationUnitCodeCompletionContext extends AbstractCodeCompletionContext {
    ...
    protected CodeFragmentCollectorLinkerImpl getCodeFragmentCollectorLinker(CodeCompletionRequest request) {
        return CodeFragmentCollectorLinkerImpl.builder()
                ...
                .linkModifierCollector(COMPILATION_UNIT)
                .build();
    }

    @Override
    public CodeFragmentInsertVisitor getCodeFragmentInsertVisitor() {
        return new CompilationUnitCodeFragmentInsertVisitor();
    }
