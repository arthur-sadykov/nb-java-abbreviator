...
import com.github.isarthur.netbeans.editor.typingaid.insertvisitor.impl.NewClassCodeFragmentInsertVisitor;
 ...
 */
public class NewClassCodeCompletionContext extends AbstractCodeCompletionContext {
    ...
    public CodeFragmentInsertVisitor getCodeFragmentInsertVisitor() {
        return new NewClassCodeFragmentInsertVisitor();
    }
    ...
    public TypeMirror getType(CodeCompletionRequest request) {
        ...
        int insertIndex =
                JavaSourceUtilities.findInsertIndexForInvocationArgument((NewClassTree) currentPath.getLeaf());
        if (insertIndex == -1) {
            return null;
        }
