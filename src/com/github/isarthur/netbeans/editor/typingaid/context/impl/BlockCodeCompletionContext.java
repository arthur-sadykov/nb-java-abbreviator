...
import com.github.isarthur.netbeans.editor.typingaid.insertvisitor.impl.BlockCodeFragmentInsertVisitor;
 ...
 */
public class BlockCodeCompletionContext extends AbstractCodeCompletionContext {
    ...
    public CodeFragmentInsertVisitor getCodeFragmentInsertVisitor() {
        return new BlockCodeFragmentInsertVisitor();
    }
