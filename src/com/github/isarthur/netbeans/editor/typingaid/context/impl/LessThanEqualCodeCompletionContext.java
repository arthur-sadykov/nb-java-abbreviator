 ...
 */
public class LessThanEqualCodeCompletionContext extends AbstractCodeCompletionContext {
    ...
    public CodeFragmentInsertVisitor getCodeFragmentInsertVisitor() {
        return new BinaryExpressionCodeFragmentInsertVisitor(LESS_THAN_EQUAL);
    }
