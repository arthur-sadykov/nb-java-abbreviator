...
import com.github.isarthur.netbeans.editor.typingaid.insertvisitor.impl.TryCodeFragmentInsertVisitor;
 ...
 */
public class TryCodeCompletionContext extends AbstractCodeCompletionContext {
    ...
    public CodeFragmentInsertVisitor getCodeFragmentInsertVisitor() {
        return new TryCodeFragmentInsertVisitor();
    }
