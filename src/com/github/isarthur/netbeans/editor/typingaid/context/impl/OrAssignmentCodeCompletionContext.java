 ...
 */
public class OrAssignmentCodeCompletionContext extends AbstractCodeCompletionContext {
    ...
    public CodeFragmentInsertVisitor getCodeFragmentInsertVisitor() {
        return new CompoundAssignmentExpressionCodeFragmentInsertVisitor(OR_ASSIGNMENT);
    }
