 ...
 */
public class PrefixIncrementCodeCompletionContext extends AbstractCodeCompletionContext {

    @Override
    public CodeFragmentInsertVisitor getCodeFragmentInsertVisitor() {
        return new UnaryExpressionCodeFragmentInsertVisitor(PREFIX_INCREMENT);
    }
