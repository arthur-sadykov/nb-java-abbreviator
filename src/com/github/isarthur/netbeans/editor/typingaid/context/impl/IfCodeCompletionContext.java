...
import com.github.isarthur.netbeans.editor.typingaid.insertvisitor.impl.IfCodeFragmentInsertVisitor;
 ...
 */
public class IfCodeCompletionContext extends AbstractCodeCompletionContext {
    ...
    public CodeFragmentInsertVisitor getCodeFragmentInsertVisitor() {
        return new IfCodeFragmentInsertVisitor();
    }
