 ...
 */
public class NullCodeCompletionContext extends AbstractCodeCompletionContext {

    private static NullCodeCompletionContext instance;

    private NullCodeCompletionContext() {
    }
    ...
    public static NullCodeCompletionContext getInstance() {
        if (instance == null) {
            instance = new NullCodeCompletionContext();
        }
        return instance;
    }
