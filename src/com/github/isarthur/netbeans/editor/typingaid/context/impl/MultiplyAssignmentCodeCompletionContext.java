 ...
 */
public class MultiplyAssignmentCodeCompletionContext extends AbstractCodeCompletionContext {
    ...
    public CodeFragmentInsertVisitor getCodeFragmentInsertVisitor() {
        return new CompoundAssignmentExpressionCodeFragmentInsertVisitor(MULTIPLY_ASSIGNMENT);
    }
