 ...
 */
public class UnsignedRightShiftCodeCompletionContext extends AbstractCodeCompletionContext {
    ...
    public CodeFragmentInsertVisitor getCodeFragmentInsertVisitor() {
        return new BinaryExpressionCodeFragmentInsertVisitor(UNSIGNED_RIGHT_SHIFT);
    }
