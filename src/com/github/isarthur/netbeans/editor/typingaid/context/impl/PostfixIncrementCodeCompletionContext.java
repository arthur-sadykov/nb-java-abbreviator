 ...
 */
public class PostfixIncrementCodeCompletionContext extends AbstractCodeCompletionContext {
    ...
    public CodeFragmentInsertVisitor getCodeFragmentInsertVisitor() {
        return new UnaryExpressionCodeFragmentInsertVisitor(POSTFIX_INCREMENT);
    }
