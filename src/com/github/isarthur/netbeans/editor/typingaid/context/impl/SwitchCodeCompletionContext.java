...
import com.github.isarthur.netbeans.editor.typingaid.insertvisitor.impl.SwitchCodeFragmentInsertVisitor;
 ...
 */
public class SwitchCodeCompletionContext extends AbstractCodeCompletionContext {
    ...
    public CodeFragmentInsertVisitor getCodeFragmentInsertVisitor() {
        return new SwitchCodeFragmentInsertVisitor();
    }
