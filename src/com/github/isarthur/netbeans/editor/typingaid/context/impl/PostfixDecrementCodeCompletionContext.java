 ...
 */
public class PostfixDecrementCodeCompletionContext extends AbstractCodeCompletionContext {

    @Override
    public CodeFragmentInsertVisitor getCodeFragmentInsertVisitor() {
        return new UnaryExpressionCodeFragmentInsertVisitor(POSTFIX_DECREMENT);
    }
