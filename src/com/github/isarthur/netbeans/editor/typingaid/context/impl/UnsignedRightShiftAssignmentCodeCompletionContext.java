 ...
 */
public class UnsignedRightShiftAssignmentCodeCompletionContext extends AbstractCodeCompletionContext {
    ...
    public CodeFragmentInsertVisitor getCodeFragmentInsertVisitor() {
        return new CompoundAssignmentExpressionCodeFragmentInsertVisitor(UNSIGNED_RIGHT_SHIFT_ASSIGNMENT);
    }
