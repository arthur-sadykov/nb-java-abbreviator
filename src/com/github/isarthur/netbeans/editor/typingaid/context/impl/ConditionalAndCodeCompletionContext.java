 ...
 */
public class ConditionalAndCodeCompletionContext extends AbstractCodeCompletionContext {
    ...
    public CodeFragmentInsertVisitor getCodeFragmentInsertVisitor() {
        return new BinaryExpressionCodeFragmentInsertVisitor(CONDITIONAL_AND);
    }
