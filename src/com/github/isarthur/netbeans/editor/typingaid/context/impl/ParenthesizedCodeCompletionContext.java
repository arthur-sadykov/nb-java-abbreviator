...
import com.github.isarthur.netbeans.editor.typingaid.insertvisitor.impl.ParenthesizedCodeFragmentInsertVisitor;
 ...
 */
public class ParenthesizedCodeCompletionContext extends AbstractCodeCompletionContext {
    ...
    public CodeFragmentInsertVisitor getCodeFragmentInsertVisitor() {
        return new ParenthesizedCodeFragmentInsertVisitor();
    }
