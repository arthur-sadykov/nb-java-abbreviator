...
import com.github.isarthur.netbeans.editor.typingaid.insertvisitor.impl.ModifiersCodeFragmentInsertVisitor;
import com.github.isarthur.netbeans.editor.typingaid.request.api.CodeCompletionRequest;
import static com.sun.source.tree.Tree.Kind.MODIFIERS;
 ...
 */
public class ModifiersCodeCompletionContext extends AbstractCodeCompletionContext {
    ...
    protected CodeFragmentCollectorLinkerImpl getCodeFragmentCollectorLinker(CodeCompletionRequest request) {
        return CodeFragmentCollectorLinkerImpl.builder()
                .linkModifierCollector(MODIFIERS)
                .build();
    }

    @Override
    public CodeFragmentInsertVisitor getCodeFragmentInsertVisitor() {
        return new ModifiersCodeFragmentInsertVisitor();
    }
