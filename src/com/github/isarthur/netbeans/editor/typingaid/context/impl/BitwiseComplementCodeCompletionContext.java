 ...
 */
public class BitwiseComplementCodeCompletionContext extends AbstractCodeCompletionContext {
    ...
    public CodeFragmentInsertVisitor getCodeFragmentInsertVisitor() {
        return new UnaryExpressionCodeFragmentInsertVisitor(BITWISE_COMPLEMENT);
    }
