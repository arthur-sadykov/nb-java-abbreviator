 ...
 */
public class LeftShiftAssignmentCodeCompletionContext extends AbstractCodeCompletionContext {

    @Override
    public CodeFragmentInsertVisitor getCodeFragmentInsertVisitor() {
        return new CompoundAssignmentExpressionCodeFragmentInsertVisitor(LEFT_SHIFT_ASSIGNMENT);
    }
