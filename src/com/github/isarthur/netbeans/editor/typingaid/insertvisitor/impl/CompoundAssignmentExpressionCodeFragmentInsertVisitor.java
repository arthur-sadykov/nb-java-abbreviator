 ...
 */
public class CompoundAssignmentExpressionCodeFragmentInsertVisitor extends AbstractCodeFragmentInsertVisitor {

    private final Tree.Kind kind;

    public CompoundAssignmentExpressionCodeFragmentInsertVisitor(Tree.Kind kind) {
        this.kind = kind;
    }
