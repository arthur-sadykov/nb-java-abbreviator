 ...
 */
package com.github.isarthur.netbeans.editor.typingaid.request.api;
 ...
 */
public interface CodeCompletionRequest {
    ...
    CodeCompletionContext getContext();

    Tree getCurrentTree();

    Tree.Kind getCurrentKind();
